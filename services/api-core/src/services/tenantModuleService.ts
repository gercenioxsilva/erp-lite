...
export const MODULE_KEYS = ['service_orders', 'multi_empresa', 'pos', 'mercadolivre', 'sales_pipeline', 'hr', 'scheduling', 'whatsapp', 'fiscal', 'contabil', 'projects', 'service_contracts', 'engine', 'lead_capture'] as const;
